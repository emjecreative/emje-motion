...
final class SmoothScroll implements ModuleInterface
{
    ...
    public function injectConfig(): void
    {
        ...
        $config = [
            ...
            'disableOnMobile' => ! empty($allSettings['disable_smooth_on_mobile']),
        ];
        ...
        if (wp_script_is('emje-motion-frontend', 'registered')) {
            ...
            add_action(
                ...
                static function () use ($json): void {
                    wp_print_inline_script_tag('window.EmjeMotionSmoothScrollConfig = ' . $json . ';', ['id' => 'emje-motion-smooth-scroll-config']);
                },
                5,
            );
        }
        ...
        add_action(
            ...
            static function (): void {
                wp_print_inline_script_tag('document.documentElement.setAttribute("data-emje-smooth-scroll","1");', ['id' => 'emje-motion-smooth-scroll-marker']);
            },
            5,
        );
    }
    ...
    {
        // Check Elementor editor/preview mode via official APIs (guarded).
        try {
            if (function_exists('elementor_is_edit_mode') && elementor_is_edit_mode()) {
                return true;
            }
        ...
        $get = wp_unslash($_GET);
        if (isset($get['elementor-preview']) || isset($get['elementor_library']) || isset($get['elementor'])) {
            return true;
        }
