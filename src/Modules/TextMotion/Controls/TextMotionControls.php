...
final class TextMotionControls
{
     ...
     */
    public function registerHeadingControls(mixed $element, array $args): void
    {
     ...
     * @param array<string, mixed> $args
     */
    public function registerTextEditorControls(mixed $element, array $args): void
    {
        $this->registerControls($element);
    }
     ...
     */
    private function registerControls(mixed $element): void
    {
        ...
        (new ScrubControls())->register($element);
    ...
    */
    private function registerGeneralControls(mixed $element): void
    {
        $element->add_control(
            'emje_motion_enable',
            [
    ...
    */
    private function registerScrambleControls(mixed $element): void
    {
        $element->add_control(
     ...
     */
    private function registerUnfoldControls(mixed $element): void
    {
        $element->add_control(
     ...
     */
    private function registerFillRevealControls(mixed $element): void
    {
        $element->add_control(
