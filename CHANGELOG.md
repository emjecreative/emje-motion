...
### Added
- **Docs** — new USER-GUIDE.md (quick start, all three modules, dashboard, troubleshooting); About Documentation card and README link to it
...
### Fixed
- **About** — Request a Feature card now opens the Feature request template directly (template parameter) with all sections prefilled
