...
(function() {
    ...
    function editorDisableOnMobile() {
        try {
    ...
    function buildPixelConfig(settings, live) {
        var get = function(k, d) { var v = settings.get(k); return v !== undefined && v !== null ? v : d; };
        var num = function(k, def, min, max) {
            var v = get(k, null);
            if (v && typeof v === 'object' && v.size !== undefined) v = v.size;
    ...
    function buildBackgroundPayload(cfg) {
        if (cfg.effect === 'pixel') {
            return {
                effect: 'pixel',
                base: cfg.base,
    ...
    function backgroundLayerPresent(target) {
        try {
    ...
    function scheduleBackgroundVerify(settings, widgetId, attempt) {
    ...
    function bindBackgroundSettingsListener() {
