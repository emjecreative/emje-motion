 ...
 * Bridge modules live in ./editor-bridge/ (utils, backgroundBridge, ...);
 * this file is the thin entry that wires them together.
 * TODO: extract textMotionBridge.js, interactionBridge.js, tooltip.js, previewSync.js next.
 */
import { sanitizeImageUrl, getPreviewWindow, getPreviewDocument, editorDisableOnMobile, isValidEditorColor, safeCssEnum, safeCssMeasure, findTarget } from './editor-bridge/utils.js';
import { initBackgroundBridge, hookBackgroundPreviewRender, buildBackgroundConfig, applyBackgroundToTarget, destroyBackgroundOnTarget } from './editor-bridge/backgroundBridge.js';
