...
const sources = {
    ...
    'mod-fillTiming.mjs': 'resources/js/modules/TextMotion/fillTiming.js',
    'mod-fillBuild.mjs': 'resources/js/modules/TextMotion/fillBuild.js',
    'mod-textSplitter.mjs': 'resources/js/services/TextSplitter.js',
    'mod-sanitizeHtml.mjs': 'resources/js/services/sanitizeHtml.js',
